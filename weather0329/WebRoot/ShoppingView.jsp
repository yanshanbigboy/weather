			...
			<div class="row">
				...
				<h6>
					...
					<form action="DataShopping" method="post">
						...
						<h5>Step5.请填写您的个人信息</h5>
						姓名*：<input type="text" name="name"><br> 单位*：<input
							type="text" name="company"><br> 联系电话*：<input
							type="text" name="phone"><br> 邮箱*：<input type="text"
							name="email"><br>其他需求：<input type="text"
							style="width:280px;height:150px;" name="other"><br>
						<input type="submit" style="width:280px;" value="提交">
					</form>
			</div>
			<!--正文结束-->
		</div>
