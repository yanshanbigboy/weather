					...
					<div class="navbar navbar_">
						<div class="container">
							<h1 class="brand brand_">
								<a href="index.html">
									<!--<span class="header1">Weather Forecast </span>-->
							...
							<div class="nav-collapse nav-collapse_  collapse">
								<ul class="nav sf-menu">
									<li><a href="UserModify.jsp">用户管理</a>
									</li>
									<li><a href="UserWeatherModify.jsp">历史数据</a>
									</li>
									<li><a href="AdminHadoop.jsp">数据分析</a>
									</li>
									<li class="sub-menu" class="active"><a>文献资料</a>
										<ul>
											<li><a href="AdminUpLoad.jsp">文件上传</a>
											</li>
											<li><a href="servlet/AdminListFileServlet">文件下载 </a>
											</li>
											<li><a href="AdminProcess3.jsp">可读文档</a>
											</li>
										</ul></li>
									<li><a href="AdminMessageboard.jsp">意见反馈</a>
									</li>
									<%
										String name = (String) session.getAttribute("name");
									%>
									<li><p3>欢迎，<%=name%></p3>
										<button onclick="window.location.href='home.jsp'">退出</button>
									</li>
								</ul>
							</div>
						</div>
