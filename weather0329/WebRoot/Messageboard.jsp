					...
					<ul class="portfolio clearfix">
						<table width="100%" border="1" cellpadding="0" cellspacing="0"
							...
							<tr align="center" bgcolor="#e3F4F7">
								...
								<td width="700px" bgcolor="#e7e8e8">回复</td>
								<td width="70" bgcolor="#e7e8e8">添加回复</td>
							</tr>
							...
							<c:forEach var="message" items="${messageList }">
								<tr align="center">
									...
									<td style="padding:7px">${message.sendContent }</td>
									<td style="padding:5px">${message.allReply }</td>
									<td style="padding:5px"><form action="addreply.message" method="post">
