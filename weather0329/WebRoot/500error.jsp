...
<header>
    ...
    <div class="row">
        ...
        <div class="navbar navbar_">
              <div class="container">
                <%if(type==0){ %>
            <h1 class="brand brand_"><a href="AdminIndex.html"><img alt="" src="img/mine/icon.jpg"> </a></h1>
            ...
            <div class="nav-collapse nav-collapse_  collapse">
                ...
                <%if(type==1){ %>
                <h1 class="brand brand_"><a href="UserIndex.html"><img alt="" src="img/mine/icon.jpg"> </a></h1>
                <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse_">Menu <span class="icon-bar"></span> </a>
                <div class="nav-collapse nav-collapse_  collapse">
                  <ul class="nav sf-menu">
